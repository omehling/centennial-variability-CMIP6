...
aux_file = "/data/datasets/synda/data/CMIP6/CMIP/CCCma/CanESM5/piControl/r1i1p2f1/Omon/thetao/gn/v20190429/thetao_Omon_CanESM5_piControl_r1i1p2f1_gn_555001-556012.nc"
...
root_path = "/data/datasets/synda/data/CMIP6/CMIP/CCCma/CanESM5/piControl/r1i1p2f1/Omon/"
data_version = "gn/v20190429"
...
s_mean = xr.open_dataset("/home/omehling/work/cmip6/piControl_salinity/so_mean_ao/soao_Omon_CanESM5_piControl_r1i1p2f1_gn.nc")["so"].mean().item()
print("Mean salinity: {:.2f}".format(s_mean))

# Grid points for Fram strait
# Indices in CanESM start from 0
fram_i = slice(267,276)
fram_j = 271
...
for load_file_idx in range(len(filenames_vo)):
    ...
    df_fwts.to_csv("fwt_canesm/fwt_CanESM_{}.csv".format(load_file_idx))
