...
aux_path = "/data/datasets/synda/data/CMIP6/CMIP/MPI-M/MPI-ESM1-2-LR/piControl/r1i1p1f1/Omon/thetao/gn/v20190710/thetao_Omon_MPI-ESM1-2-LR_piControl_r1i1p1f1_gn_185001-186912.nc"
...
root_path = "/data/datasets/synda/data/CMIP6/CMIP/MPI-M/MPI-ESM1-2-LR/piControl/r1i1p1f1/Omon/"
...
s_mean = xr.open_dataset("/home/omehling/work/cmip6/piControl_salinity/so_mean_ao/soao_Omon_MPI-ESM1-2-LR_piControl_r1i1p1f1_gn.nc")["so"].mean().item()
...
for load_file_idx in range(len(filenames_vo)):
    ...
    df_fwts.to_csv("fwt_mpi-lr/fwt_MPI-LR_{:02d}.csv".format(load_file_idx))
