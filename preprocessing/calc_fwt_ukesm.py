...
aux_file = "/data/datasets/synda/data/CMIP6/CMIP/MOHC/UKESM1-0-LL/piControl/r1i1p1f2/Omon/thetao/gn/v20190827/thetao_Omon_UKESM1-0-LL_piControl_r1i1p1f2_gn_196001-199912.nc"
...
root_path = "/home/omehling/synda-CMIP/MOHC/UKESM1-0-LL/piControl/r1i1p1f2/Omon/"
...
s_mean = xr.open_dataset("/home/omehling/work/cmip6/piControl_salinity/so_mean_ao/soao_Omon_UKESM1-0-LL_piControl_r1i1p1f2_gn.nc")["so"].mean().item()
print("Mean salinity: {:.2f}".format(s_mean))

# Grid points for Fram strait
# Indices in UKESM start from 0
...
for load_file_idx in range(len(filenames_vo)):
    ...
    df_fwts.to_csv("fwt_ukesm/fwt_UKESM_{:02d}.csv".format(load_file_idx))
